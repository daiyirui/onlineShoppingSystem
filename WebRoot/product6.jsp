...
<label><input name="size" type="radio" value="27" />27</label> 
<label><input name="size" type="radio" value="28" />28</label> 
<label><input name="size" type="radio" value="29" />29 </label> 

<label><input name="size" type="radio" value="30" />30</label> 
<label><input name="size" type="radio" value="31" />31</label> 
<label><input name="size" type="radio" value="32" />32 </label> 
     <p>
