...
return  false;
	...
	function add(userid,productid){
	       ...
	       return;
                ...
                alert("成功加入购物车");
                   document.location.href="./ShoppingcartManagerServlet?userid="+userid+"&productid="+productid+"&action=addShoppingcart&number="+number;
	...
	function pay(userid,productid){
       ...
       if(isNumber(number)==false){
	       ...
	       return;
            ...
            alert("请稍等，跳转付款界面！！！");
                 document.location.href="OrderManagerServlet?userid="+userid+"&productid="+productid+"&action=pay&number="+number;
