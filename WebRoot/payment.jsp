...
<div class="my_shopping">
	...
	<td>
	<span class="span_w1">商品名:${product.productname }</span>&nbsp;&nbsp;&nbsp;
	</td>
	<td class="buy_td_4">
	<span class="span_w3">原价：${discountprice }</span>&nbsp;&nbsp;&nbsp;
	</td>
	<td class="buy_td_4">
	<span class="span_w3">折后单价：${discountprice }</span>&nbsp;&nbsp;&nbsp;
	</td>
	<td class="buy_td_4">
	<span class="span_w3">尺码：${size }</span>&nbsp;&nbsp;&nbsp;
	</td>
	<td class="buy_td_1">
	<span class="span_w2">数量:${number }</span>&nbsp;&nbsp;&nbsp;
	</td>
		<td class="buy_td_1">
	<span class="span_w2">总金额:${allmoney }</span>&nbsp;&nbsp;&nbsp;
	</td>
...
<button onclick="window.location.href='OrderManagerServlet?userid=${userid}&action=addOrder&productid=${product.productid }&number=${number }&size=${size }'">付款</button>
