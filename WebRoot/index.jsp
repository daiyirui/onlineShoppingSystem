...
<body>
	...
	<div class="header">
		...
		<div class="container">
			<div class="head-top">
				<div class="logo">
					<a href="login.jsp"><img src="images/logo.jpg" alt=""></a>
				</div>
				<div class=" h_menu4">
					<ul class="memenu skyblue">
						<li class="active grid"><a class="color8" href="OtherManagerServlet?action=index">主页</a></li>
						<li><a class="color1" href="#">分类</a>
							<div class="mepanel">
								...
								<c:when test="${6>=cla.classid&&cla.classid>=1}">
												...
												<li><a href="OtherManagerServlet?action=showAllProductByClass&classid=${ cla.classid}">${ cla.classname}</a></li>
						     	</c:when>
			            </c:choose>
	                    	   </c:forEach>
									</ul>
	...
	<div align="center">
			<a href="OtherManagerServlet?action=showPopularity&classid=${classid}">按人气查询</a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="OtherManagerServlet?action=showHotsale&classid=${classid}">按销量查询</a>
			</div>
			<br><br><br><br><br><br>	
...
<c:forEach items="${browseproducts}"  var="browseproduct"  begin="0" end="2">
			...
			<div class="col-md-4 grid-top">
					<a href="OtherManagerServlet?browseproductid=${browseproduct.browseproductid}&action=showOneProduct" class="b-link-stripe b-animate-go  thickbox"><img
					...
					<p>
						<a href="OtherManagerServlet?browseproductid='${browseproduct.browseproductid}'&action=showOneProduct">产品名：${browseproduct.browseproductname }  人气指数：${browseproduct.popularity }  销量：${browseproduct.hotsale }</a>
					</p>
				</div>
